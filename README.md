...
```bash
https://github.com/XinLang2019/wheel_legged_ts.git
cd wheel_legged_ts
```

Download isaacgym
1. Create a new python virtual env with python 3.6, 3.7 or 3.8 (3.8 recommended):
    - `conda create -n wl-ts python=3.8`
    - `conda activate wl-ts`
2. Install pytorch:
...
```python legged_gym/scripts/play.py --task=go2w --if_student```c
